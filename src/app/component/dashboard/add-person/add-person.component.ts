...
export class AddPersonComponent implements OnInit {
  ...
  preencherCamposEndereco = (dataVIACEP: {
    ...
    this.person.cep = cepInput.value || "";
    this.person.logradouro = logradouroInput.value || "";
    this.person.bairro = bairroInput.value || "";
    this.person.cidade = cidadeInput.value || "";
    this.person.estado = estadoInput.value || "";
